...

{
  programs.yazi = {
      ...
      mgr = {
        append_keymap = [
...

          {
            ...
            desc = "Linemode: size and modification time";
          }
          {
            on = [
              "m"
            ...
            run = "linemode size_and_btime";
            desc = "Linemode: size and creation time";
          }
          ...
          }
          {
            ...
            desc = "Archive selected files to 7z";
          }
          {
            on = [
              "C"
            ...
            run = "plugin compress rar";
            desc = "Archive selected files to rar";
          }
          {
            on = [
              "C"
    ...
    settings = {
      plugin = {
        # REMOVED the extra nested `yazi = { ... }` block here
        prepend_preloaders = [
          {
